...
const Auth = () => {
  ...
  const { user, signIn, signUp, signInWithGoogle, signInWithApple, resetPassword, loading } = useAuth();
  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Something went wrong with Apple sign in. Please try again.",
        variant: "destructive",
      });
    } finally {
